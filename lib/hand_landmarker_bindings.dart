...
extension type MyHandLandmarker._(jni$_.JObject _$this)
  ...
  factory MyHandLandmarker(Context context) {
...
extension MyHandLandmarker$$Methods on MyHandLandmarker {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  HandLandmarkListener? get listener {
    final _$$selfRef = reference;
    return _get$listener(
      _$$selfRef.pointer,
      _id_get$listener.pointer,
    ).object<HandLandmarkListener?>();
  }
...
/// from: `io.github.iot_gamer.hand_landmarker.HandLandmarkListener`
///
/// WARNING: HandLandmarkListener is a stub. To generate bindings for this class, include
/// io.github.iot_gamer.hand_landmarker.HandLandmarkListener in your config's classes list.
///
extension type HandLandmarkListener._(jni$_.JObject _$this)
    implements jni$_.JObject {
  static const jni$_.JType<HandLandmarkListener> type =
      $HandLandmarkListener$Type$();
}

final class $HandLandmarkListener$Type$
    extends jni$_.JType<HandLandmarkListener> {
  @jni$_.internal
  const $HandLandmarkListener$Type$();
